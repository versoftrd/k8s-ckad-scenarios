Crea un solo Pod de la imagen `httpd:2.4.41-alpine` en el Namespace `default`. El Pod debe ser nombrado como `pod1` y el contenedor debe ser nombrado como `pod1-container`.
